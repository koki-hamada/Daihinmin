...
// ...しているのだがそうなっていないようだ
#define VALUE_PER_CLOCK (5.0 / (THINKING_LEVEL * THINKING_LEVEL) / pow((double)10.0, 8))
#endif
#define VALUE_PER_SEC (VALUE_PER_CLOCK * 3191 * pow((double)10.0, 6)) // 時間の価値(1秒あたり),3191はうちのPCのクロック周波数(/microsec)
